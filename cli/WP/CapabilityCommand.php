...
class CapabilityCommand extends \WP_CLI_Command
{
     ...
     *     wp wppermission capability:create view_analytics --description="View analytics dashboard" --group="analytics"
     *
     * @when after_wp_load
     */
     ...
     * ## EXAMPLES
     *
     *     wp wppermission capability:delete manage_products
     *     wp wppermission capability:delete manage_products --yes
     *
     * @when after_wp_load
     */
     ...
     *     wp wppermission capability:list --group=custom
     *     wp wppermission capability:list --type=default --format=json
     *
     * @when after_wp_load
     */
